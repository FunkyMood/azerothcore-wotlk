...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<float>(RATE_SPELL_MANA_COST_LEVEL_1_10, "Rate.Spell.ManaCost.Level1To10", 1.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value > 0.0f; }, "> 0");
    SetConfigValue<float>(RATE_SPELL_MANA_COST_LEVEL_11_20, "Rate.Spell.ManaCost.Level11To20", 1.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value > 0.0f; }, "> 0");
    SetConfigValue<float>(RATE_SPELL_MANA_COST_LEVEL_21_30, "Rate.Spell.ManaCost.Level21To30", 1.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value > 0.0f; }, "> 0");
    SetConfigValue<float>(RATE_SPELL_MANA_COST_LEVEL_31_40, "Rate.Spell.ManaCost.Level31To40", 1.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value > 0.0f; }, "> 0");
    SetConfigValue<float>(RATE_SPELL_MANA_COST_LEVEL_41_PLUS, "Rate.Spell.ManaCost.Level41Plus", 1.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value > 0.0f; }, "> 0");
